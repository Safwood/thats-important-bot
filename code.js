  ...
  callback_query: {
    ...
    message: {
      ...
      from: {
        id: 7053208106,
        is_bot: true,
        first_name: "That's Important",
        username: "ThatsImportantBot",
      },
      chat: {
        id: 1127224992,
        first_name: "Anastasia",
      ...
      date: 1715516159,
      text: "Выберите задачу для редактирования. Для добавления новой задачи, просто отправьте боту название задачи. Максимально 33 символа.",
      reply_markup: {
        inline_keyboard: [
          [
            {
              text: "Приложение Артему",
              callback_data: "9_1_0_0_Приложение Артему",
            },
            {
              text: "Сервер",
              callback_data: "9_2_0_0_Сервер",
            },
          ],
          [
            {
              text: "Парта/Кресло",
              callback_data: "9_3_0_0_Парта/Кресло",
            },
            {
              text: "Опека",
              callback_data: "9_4_0_0_Опека",
            },
          ],
          [
            {
              text: "Справка в школу",
              callback_data: "9_7_0_0_Справка в школу",
            },
            {
              text: "Поведенческая терапия",
              callback_data: "9_8_0_0_Поведенческая терапия",
            },
          ],
          [
            {
              text: "Прививка Дане",
              callback_data: "9_702670_0_0_Прививка Дане",
            },
            {
              text: "Алгоритмы",
              callback_data: "9_466768_0_0_Алгоритмы",
            },
          ],
          [
            {
              text: "Убунту",
              callback_data: "9_48686_0_0_Убунту",
            },
            {
              text: "23 бассейн",
              callback_data: "9_703102_0_0_23 бассейн",
            },
          ],
          [
            {
              text: "Подарок",
              callback_data: "9_228814_0_0_Подарок",
            },
            {
              text: "Go",
              callback_data: "9_639397_0_0_Go",
            },
          ],
          [
            {
              text: "Лампа для маникюра",
              callback_data: "9_66591_0_0_Лампа для маникюра",
            },
            {
              text: "Авито2",
              callback_data: "9_464907_0_0_Авито2",
            },
          ],
          [
            {
              text: "Средства для роста волос",
              callback_data: "9_580124_0_0_Средства для роста волос",
            },
            {
              text: "Крем для лица",
              callback_data: "9_342714_0_0_Крем для лица",
            },
          ],
          [
            {
              text: "аа",
              callback_data: "9_3876_0_0_аа",
            },
          ],
        ],
      },
    },
    chat_instance: "-3200968912628710736",
    data: "9_3876_0_0_аа",
  },
};
